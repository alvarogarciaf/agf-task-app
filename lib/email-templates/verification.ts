/**
 * Generates a bulletproof, responsive HTML email template for email verification.
 * Compatible across all major email clients (Desktop Outlook, Gmail, Apple Mail, iOS, Android).
...
export function renderVerificationEmailHtml(options: VerificationEmailOptions): string {
  const {
    verificationUrl,
    email,
    appName = "Tasker AGF",
...
<head>
  ...
  <title>Verify your email address for ${appName}</title>
  <!--[if mso]>
  <style type="text/css">
                ...
                <tr>
                  <td align="center">
                    <a href="${appUrl}" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center;">
                      <span style="font-size: 20px; font-weight: 800; letter-spacing: -0.5px; color: #09090b; text-transform: uppercase;">TASKER AGF</span>
                    </a>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding-bottom: 20px;">
                    <div style="display: inline-block; width: 56px; height: 56px; border-radius: 50%; background-color: #f0fdf4; border: 1px solid #bbf7d0; text-align: center; line-height: 56px;">
                      <!-- Checkmark / Mail SVG -->
                      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;">
                ...
                <tr>
                  <td align="left" style="padding-bottom: 24px;">
                    <p class="body-text" style="margin: 0 0 12px 0; font-size: 15px; line-height: 24px; color: #52525b;">
                      Thanks for creating an account with <strong>${appName}</strong>${email ? ` (<strong>${email}</strong>)` : ""}.
                    </p>
                    <p class="body-text" style="margin: 0; font-size: 15px; line-height: 24px; color: #52525b;">
                      To finish setting up your account and protect your workspace, please verify your email address by clicking the button below:
                    </p>
                  </td>
                </tr>
              </table>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" style="border-radius: 8px; background-color: #09090b;">
                          <a href="${verificationUrl}" class="cta-button" target="_blank" style="display: inline-block; background-color: #09090b; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; letter-spacing: -0.2px;">
                ...
                <tr>
                  <td style="padding: 14px 16px;">
                    ...
                    <p style="margin: 0; font-size: 12px; line-height: 18px; word-break: break-all;">
                      <a href="${verificationUrl}" target="_blank" style="color: #2563eb; text-decoration: underline;">
                        ${verificationUrl}
                      </a>
                    </p>
                  </td>
