...
export function InboxView({
  ...
  if (inbox.length === 0 && invites.length === 0) {
    return (
      <div className="px-2 py-6 md:px-6 md:py-12">
        <div className="mx-auto flex max-w-md flex-col items-center rounded-lg border border-dashed border-border bg-card px-4 py-8 text-center">
