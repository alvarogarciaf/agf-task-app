        ...
        {contexts.map((c) => {
          ...
          return (
            <button
              ...
              className="group relative flex aspect-[4/3] sm:aspect-[4/3] flex-col justify-between overflow-hidden rounded-xl border border-border bg-card p-5 text-left transition-all hover:border-primary/40 hover:bg-card/80 md:p-4"
            >
              <div
              ...
              <div className="relative flex items-center justify-between">
                <div
                  className="flex h-10 w-10 items-center justify-center rounded-md ring-1 md:h-9 md:w-9"
                  style={{
