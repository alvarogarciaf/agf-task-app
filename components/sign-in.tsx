      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-border bg-card text-base font-medium transition-colors hover:bg-muted disabled:cursor-not-allowed disabled:opacity-50 md:h-11 md:text-sm"
          >
        ...
        <p className="text-center text-xs text-muted-foreground">
          ...
          <br />
          Sign in to identify your workspace.
        </p>
      </div>
    </div>
  )
